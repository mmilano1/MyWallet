    ...
    <ChartCard title="Top 10 Categories" subtitle="By total spending" height={350}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Bar dataKey="amount" name="Total Spent" radius={[0, 8, 8, 0]}>
            {top10.map((_, i) => (
              <Cell key={i} fill={`url(#catGrad${i})`} />
            ))}
            <LabelList dataKey="amount" position="right" fontSize={12} fontWeight={600} fill={chart.labelFill} formatter={(v) => abbreviateCurrency(v)} />
          </Bar>
        </BarChart>
      </ResponsiveContainer>
    </ChartCard>
